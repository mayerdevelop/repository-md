...
export declare class PoPageJobSchedulerExecutionComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit(): void;
    onChangeContainsFrequency(containsFrequency: any): void;
    onChangePeriodicityOptions(periodicity: any): void;
    onChangeFrequencyOptions(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoPageJobSchedulerExecutionComponent, "po-page-job-scheduler-execution", never, { "isEdit": "p-is-edit"; "literals": "p-literals"; "noParameters": "p-no-parameters"; "value": "p-value"; }, { "changeProcess": "p-change-process"; }, never, never, false>;
}
