...
export declare abstract class PoModalPasswordRecoveryBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoModalPasswordRecoveryBaseComponent, never, never, { "codeError": "p-code-error"; "urlRecovery": "p-url-recovery"; "contactEmail": "p-contact-email"; "phoneMask": "p-phone-mask"; "type": "p-type"; }, { "codeSubmit": "p-code-submit"; "submit": "p-submit"; }, never, never, false>;
}
