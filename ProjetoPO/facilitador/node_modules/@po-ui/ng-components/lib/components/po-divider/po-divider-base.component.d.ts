 ...
 */
export declare class PoDividerBaseComponent {
    /** Valor do rótulo a ser exibido. */
    label?: string;
    static ɵfac: i0.ɵɵFactoryDeclaration<PoDividerBaseComponent, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoDividerBaseComponent, never, never, { "label": "p-label"; }, {}, never, never, false>;
}
