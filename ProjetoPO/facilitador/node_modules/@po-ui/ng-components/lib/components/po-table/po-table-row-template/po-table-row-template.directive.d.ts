...
export declare class PoTableRowTemplateDirective {
    ...
    private _tableRowTemplateArrowDirection;
    /**
     * @optional
     *
     * @description
     ...
     * @default `'LEFT'`
     */
    set tableRowTemplateArrowDirection(value: PoTableRowTemplateArrowDirection);
    get tableRowTemplateArrowDirection(): PoTableRowTemplateArrowDirection;
    constructor(templateRef: TemplateRef<any>);
    static ɵfac: i0.ɵɵFactoryDeclaration<PoTableRowTemplateDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTableRowTemplateDirective, "[p-table-row-template]", never, { "poTableRowTemplateShow": "p-table-row-template-show"; "tableRowTemplateArrowDirection": "p-table-row-template-arrow-direction"; }, {}, never, never, false>;
}
