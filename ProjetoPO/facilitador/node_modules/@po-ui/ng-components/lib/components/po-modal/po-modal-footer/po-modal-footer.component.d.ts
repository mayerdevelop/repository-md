 ...
 * ```
 */
export declare class PoModalFooterComponent {
    /**
     * @optional
     *
     * @description
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<PoModalFooterComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<PoModalFooterComponent, "po-modal-footer", never, { "disabledAlign": "p-disabled-align"; }, {}, never, ["*"], false>;
}
